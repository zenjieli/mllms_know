...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel):
    ...
    def generate(
        ...
        **generate_kwargs,
        ...
        num_image_per_question = pixel_values.shape[0] // batch_size
        ...
        query_attention_mask = torch.ones(query_tokens.size()[:-1], dtype=torch.long, device=image_embeds.device)
        qformer_input_ids = qformer_input_ids.repeat(num_image_per_question, 1)
        ...
        language_model_inputs = torch.reshape(language_model_inputs, (batch_size, num_image_per_question*32, -1))
        language_attention_mask = torch.reshape(language_attention_mask, (batch_size, num_image_per_question*32))
